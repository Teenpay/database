...
CREATE UNIQUE INDEX IF NOT EXISTS ix_users_username_lower
	...
	ALTER TABLE teenpay.users ADD COLUMN IF NOT EXISTS personal_code text;
CREATE UNIQUE INDEX IF NOT EXISTS ux_users_personal_code ON teenpay.users(personal_code);
